...
var items = [
    TodoItem(text: "Купить сыр", importance: .important, deadline: Date() + 90342, category: .hobby),
    TodoItem(text: "Купить голубой сыр с плесенью черного цвета весом 452 грамма в магазине торгового центра на втором этаже около лифта слева", importance: .important, category: .studying),
    TodoItem(text: "Сделать пиццу с колбасой, купленным сыром и помидорами", importance: .usual, deadline: Date() + 896355, isCompleted: true, category: .work),
    TodoItem(text: "Убрать посуду после готовки, обязательно без использования моющих средств", importance: .unimportant, deadline: Date() + 128456, category: .studying),
    TodoItem(text: "Съесть пиццу", importance: .important, deadline: Date() + 179368, isCompleted: true, category: .hobby),
    TodoItem(text: "Купить сыр", importance: .important, deadline: Date() + 90342, category: .work),
